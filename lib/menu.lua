...
-- controller --
ga.Menu = class(function(user, title, noskip)
    self.user = user
...
addhook('menu', 'gajosmenu.onMenu', -7)

-- model --
ga.MenuModel = classExtends(Model, function(controller, user)
